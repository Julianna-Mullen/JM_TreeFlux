...
```{r}
ggplot(quarterly_CH4 |> filter(!is_S7),
       aes(x = YearQuarter, 
           y = mean_flux,
           color = Plot)) +
  geom_line() +
  ...
  geom_errorbar(aes(ymin = mean_flux - se, 
                ...
                width = 0.1 ) +
  facet_wrap(~ Species) +
  labs( title = "Mean CH4 Flux by Species and Plot (2021–2026)",
        subtitle = "(No S7)",
...
ggplot(quarterly_CO2,
  ...
  geom_errorbar(aes(ymin = mean_flux - se,
                ...
                width = 0.1) +
  facet_wrap(~ Species) +
  labs( title = "Mean CO2 Flux by Species and Plot (2021–2026)",
        subtitle = "(No S7)",
        x = "Year",
